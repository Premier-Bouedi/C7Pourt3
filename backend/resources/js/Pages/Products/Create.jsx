    ...
    <AdminLayout>
      ...
      <div className="space-y-8">
        ...
        <div className="border-b border-stone-200 pb-6">
          <h1 className="text-3xl font-bold text-stone-900">Nouveau Produit</h1>
          <p className="mt-1 text-sm text-stone-600">Ajouter un nouveau sac de luxe au catalogue</p>
        </div>
